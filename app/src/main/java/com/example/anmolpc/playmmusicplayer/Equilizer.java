...
public class Equilizer extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eq = new Equalizer (0, MediaPlayerService.player.getAudioSessionId());
        if (eq != null)
        {
            eq.setEnabled (true);
